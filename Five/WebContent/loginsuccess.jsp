...
<body>
	<div class="wai">
		...
		<div class="lun">
			...
			<div class="p">
				<p>
					您现在的位置：<a href="index.jsp">首页></a> <a href="person.jsp">我的蜗牛></a> <a
						href="person.jsp">用户信息</a>
				</p>
			</div>
			<div class="per">
				<div class="per1">
					...
					<div class="persondiv">
						<table class="persontab">
							...
							<tr>
								...
								<td class="tximg">
									<div class="nan">
										<s:if test="#session.user.userSex==true">女</s:if>
										<s:else>男</s:else>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td class="tximg">
									<div class="nan">
										<s:property value="#session.user.UserBirth" />
									</div>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="tximg">
									<div class="nan">
										<s:property value="#session.user.UserAdd" />
									</div>
								</td>
							</tr>
							...
							<tr>
								<td class="tx"></td>
								<td class="tximg"><a href="loginmod.jsp"><input
										type="button" class="xg" value="修改个人信息" /></a></td>
							</tr>

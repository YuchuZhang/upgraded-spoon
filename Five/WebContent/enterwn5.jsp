  ...
  <script type="text/javascript" src="res/jquery-3.2.1.js"></script>
    <style type="text/css">
        *{list-style: none;text-decoration: none;}
        ...
        .p a{color: grey;}
        .per1{width:320px;height: 1050px;border: 1px solid #ddd;background-color: #ffffff;margin-left: 6%;}
        .per2{width:850px;height: 1030px;border: 1px solid #ddd;background-color: #ffffff;padding-top: 20px;
            ...
            <div class="per2">
                <ul>
                   <li><div class="location">
                    ...
                    <p class="per2title">企业宗旨：服务大众 奉献社会</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;天天快递的宗旨便是“服务大众、奉献社会”——以至真至纯的心和安全踏实的行动，为每一个客户提供天天无微不至的优质服务。</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;天天快递把社会责任融入企业发展的每一个环节之中，使天天不断壮大，从成功走向优秀，走向卓越。</p>



                    <p class="per2title">企业理念：快速物流、安全抵达、品质服务、追求满意</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;天天快递本着“方便、快捷、安全、贴心”的理念，竭诚为每一位客户提供优质的服务。用心呵护每一份快件，以通畅的运输网络，尽职尽责的快递员队伍，确保快件安全、及时到达。</p>


                    <p class="per2title">企业精神：诚信 务实 创新</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;诚信是每一个人的立身之本，更是天天保持高品质的前提。以诚信为基础的品质是天天对员工、对社会的承诺。天天人坚持诚实、守信的优秀品质。</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务实是天天可持续发展的基础。天天人在服务大众、服务社会的过程中，踏实、肯干，一步一个脚印，容不得半点虚假。</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;创新是一个企业永葆生机的法宝，也是天天企业文化的精髓。天天人秉承提供优质服务的理念，革新换旧，不断创造，不断改变，实现天天快递的快速发展。</p>
                    <img src="picture/jyln.png">
                </ul>

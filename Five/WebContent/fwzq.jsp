	...
	<script type="text/javascript" src="res/jquery-3.2.1.js"></script>
		...
		<script type="text/javascript" language="JavaScript">
			...
			$(function() {
				...
				function codes() {
					var ranColor = '#' +
						('00000' + (Math.random() * 0x1000000 << 0).toString(16)).slice(-6); //随机生成颜色
					// alert(ranColor)
				...
				<div class="per">
					...
					<div class="per2">
						<ul>
							...
							<p class="per2title">快件查询</p>
							<!---->
							
								<input style="width: 660px; height: 30px;" placeholder="请输入单号"  />
					
							<!--随机验证码-->
							<div>
							<p style="margin-top: 30px;"></p>
							
							<font size="4">点击生成随机验证码：</font>  
							
							<p id="ran" style="width:60px;height:40px;border:1px solid red;
								text-align:center;font-family:  Arial, Helvetica, 
								sans-serif;vertical-align:middle;color: blue;font-size: 25px;" onclick="ran()">
							</p>
							...
							<img src="picture/map.PNG"  width="600px" height="300px"/>
							</div>
						</ul>
  ...
  <a target="_blank" href="http://amos.im.alisoft.com/getcid.aw?v=3&uid=蜗牛快递客服中心&site=cntaobao&groupid=220229&s=1&charset=utf-8">旺旺咨询</a>
	...
	<script>
		...
		function ran() {
			...
			document.getElementById('ran').innerText = s;
		}
	</script>

		...
		<div class="lun">
			...
			<div class="sele">
				...
				<table cellspacing="0">
					...
					<s:if test="selectOrderID!=null">
						<s:iterator value="selectOrderID">
							<tr align="center">
								<td><s:property value="logNo" /></td>
								<td>在途中</td>
								<td><s:property value="output" /></td>
								<td><s:property value="inputAdd" /></td>
								<td><s:property value="outDate" /></td>
								<td><s:property value="inputPhone" /></td>
								<td><s:property value="inputAdd" /></td>
							</tr>
						</s:iterator>
					</s:if>
					<s:elseif test="selectOrderID==null">

						<tr align="center">
							<td colspan="7">查不到该订单信息</td>
						</tr>
					</s:elseif>

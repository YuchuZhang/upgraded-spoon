...
<script type="text/javascript" src="res/jquery-3.2.1.js"></script>
    <style type="text/css">
        *{list-style: none;text-decoration: none;}
        ...
        .lun {width: 100%;height:1140px;border: 0px solid yellow;background-color: gainsboro;}
        .map img{width: 100%;height: 400px;}

        .p{font-size: 13px;line-height: 16px;margin-left: 70px;color: black;color: grey;}
        .p a{color: grey;}
        .per1{width:300px;height: 600px;border: 1px solid #ffffff;background-color: #ffffff;margin-left: 90px;}
        .per2{width:855px;height: 580px;border: 1px solid #ffffff;background-color: #ffffff;padding-top: 20px;
         position: absolute;top:563px;right:70px;margin-left: 30px; }
        ...
        .per2 ul li a:hover{color: red;}
         .btn{float: left;margin-left: 40px;}
...
<div class="wai">
    ...
    <div class="lun">
        <div class="map">
            <img src="picture/xw.jpg">
        </div>
        <div class="p">
            <p>您现在的位置：<a href="index.jsp">首页></a>
                <a href="woniuNews.jsp">蜗牛新闻></a>
                <a href="woniuNews.jsp">新闻动态</a></p>
        </div>
        <div class="per">
            <div class="per1">
                <ul>
                    <li><p>&nbsp;&nbsp;&nbsp;蜗牛新闻</p></li>
                    <li><a href="woniuNews.jsp">-&nbsp;企业新闻</a></li>
                    <li><a href="woniuNews.jsp">-&nbsp;行业动态</a></li>
                    <li><a href="woniuNews.jsp">-&nbsp;信息公告</a></li>
                    <li><a href="woniuNews.jsp">-&nbsp;公益慈善</a></li>
                </ul>
            </div>
            <div class="per2">
                <ul><span id="qxw">企业新闻</span>
                    <hr style="height:1px;border:none;border-top:3px solid blue;" />
                <li><a href="#"> “加快融合，持续发展“——天天快递2018系统优化及服务提升座谈会</a><span>2018-09-16</span></li>
                <li><a href="#"> 天天快递芜湖分公司快递员获省级劳动奖章——“做服务，我们是认真的！”</a><span>2018-09-13</span></li>
                    <li><a href="#">抓服务、树品牌，天津天天快递召开2018年网络大会</a><span>2017-09-27</span></li>
                    <li><a href="#">3月快递业“红黑榜”出炉！天天快递申诉率大幅下降</a><span>2018-01-22</span></li>
                    <li><a href="#">武汉天天，因你们而精彩！</a><span>2018-09-21</span></li>
                    <li><a href="#">天天快递强势开启2018：15亿服务奖励基金，三年单量破2000万，服务冲刺第一</a><span>2018-07-12</span></li>
                    <li><a href="#">天天快递上海公司大忙时期风采</a><span>2018-09-29</span></li>
                    <li><a href="#">【天天快递的故事】大学生的创业史</a><span>2018-09-21</span></li>
                    <li><a href="#">双十二必胜！天天快递淮安分拨严阵以待！</a><span>2018-09-21</span></li>
                    <li><a href="#">新融入，心融入 ——天天快递福州公司苏宁企业文化行活动</a><span>2018-04-28</span></li>
                    <li><a href="#">【天天快递的故事】儿子，爸爸想给你更好的生活</a><span>2017-09-14</span></li>
                    <li><a href="#">【天天快递的故事】身残志坚的快递员</a><span>2018-09-21</span></li>
                    <li><a href="#">【天天快递的故事】爱就是天天相伴</a><span>2018-09-21</span></li>
                    <li><a href="#">【天天快递的故事】伤病也打败不了我们送件的激情</a><span>2016-07-11</span></li>
                    <li><a href="#">【天天快递的故事】平凡的感动</a><span>2018-09-21</span></li>

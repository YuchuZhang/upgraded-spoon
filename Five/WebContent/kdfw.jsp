				...
				<div class="per">
					...
					<div class="per2">
						<ul>
							...
							<p class="per2title">同城快递服务</p>
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 结合同城配送需求，专门组织作业，确保同城快件以最快速度及时、准确送达。 </p>
							<img src="picture/kd2.png" width="440px">

							<p class="per2title">国内异地快递服务</p>
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 全网协作、全程有效中转快件，确保异地快件以最快速度安全送达。 </p>
							<img src="picture/c.jpg" width="450px" height="180px" style="margin-left: 120px;">

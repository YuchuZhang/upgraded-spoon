  ...
  <script type="text/javascript" src="res/jquery-3.2.1.js"></script>
    <style type="text/css">
        *{list-style: none;text-decoration: none;}
        ...
        .p a{color: grey;}
        .per1{width:300px;height: 720px;border: 1px solid #ffffff;background-color: #ffffff;margin-left: 90px;}
        .per2{width:855px;height: 700px;border: 1px solid #ffffff;background-color: #ffffff;padding-top: 20px;
        ...
        <div class="per">
            ...
            <div class="per2">
                <ul><span id="qxw">加盟须知</span>
                 ...
                 <img src="picture/jm5.PNG" style="margin-left:40px ; height: 588px;"/>

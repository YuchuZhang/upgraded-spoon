	...
	<div class="wai">
		...
		<div class="lun">
			...
			<div class="reg">
				<div class="reg1">
					<center>
						<h2 style="color: #0055a2;">会员注册</h2>


						<table>
							<s:form action="user_addUser" namespace="/" method="post">
								<s:textfield name="userPhone" key="phone" />
								<s:textfield name="UserEmail" key="email" />
								<s:textfield name="userPWd" key="pwd" />
								<s:submit value="提交" style="margin-left:75px;" />
							</s:form>
						</table>
					</center>
				...
				<div class="reg2">
					<table>
						<p>
						<h2 style="color: #0055a2;">欢迎注册蜗牛速递会员</h2>
						</p>
						<P>1、如有疑问可以直接联系在线客服</P>
						<p>
							<img src="picture/ww.png"><img src="picture/qq.png">
						</p>
						<P>2、如已经注册账号可直接点击登录</P>
						<p>
							<a href="login.html"><input type="submit" value="点击登录"></a>
						</p>
					</table>

...
<script type="text/javascript" src="res/jquery-3.2.1.js"></script>
    <style type="text/css">
        *{list-style: none;text-decoration: none;}
        ...
        .lun {width: 100%;height:1120px;border: 0px solid yellow;background-color: gainsboro;}
        .map img{width: 100%;height: 400px;}

        .p{font-size: 13px;line-height: 16px;margin-left: 70px;color: black;color: grey;}
        .p a{color: grey;}
        .per1{width:290px;height: 600px;border: 1px solid #ffffff;background-color: #ffffff;margin-left: 70px;}
        .per2{width:755px;height: 580px;border: 1px solid #ffffff;background-color: #ffffff;padding-top: 20px;
       position: absolute;top:563px;right:70px; }
        ...
        .per1 ul li{width: 292px;height:50px;border: 1px solid gainsboro;line-height: 50px;}
        .per1 ul li a{color:grey;}
        .per1 ul li:hover{background-color:#47B4FC;}
        .per1 ul li a:hover{color: #ffffff;}
        .per2 ul{float: left;}
        .per2 ul li p{color: #0055a2;line-height: 50px;margin: auto;font-size: 22px;margin: auto;}
        .per2 ul li{width: 755px;;height:50px;border: 0px solid gainsboro;line-height: 50px;margin-left: -40px;margin-top: -37px;
        ...
        <div class="per">
            <div class="per1">
                <ul>
                    <li><p>&nbsp;&nbsp;&nbsp;蜗牛人才</p></li>
                    <li><a href="person.jsp">-&nbsp;人才计划</a></li>
                    <li><a href="person.jsp">-&nbsp;虚位以待</a></li>
                    <li><a href="person.jsp">-&nbsp;职业成长</a></li>
                </ul>
            </div>
            <div class="per2">
                <ul>
                <li><p>&nbsp;&nbsp;&nbsp;蜗牛人才</p></li>
                    <p class="per2title">用人理念：德才兼备，唯能是用</p>
                    <p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;二十一世纪企业之前的竞争归根结底是人才的竞争天天快递坚持
                        “能者上、庸者下、平者让”的人才思路，企业不唯学历重能力、不唯资历重业绩、赛马原则使任何员工均有机会
                        脱颖而出，竞聘上岗制度使任何员工都可以参加空缺岗位的应聘。</p>

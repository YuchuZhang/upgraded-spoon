				...
				<div class="per">
					...
					<div class="per2">
						<ul>
							...
							<p class="per2title">蜗牛客户端APP下载</p>
							<img src="picture/er.jpg" width="160px" height="160px" style="margin-left: 200px;">
							<li>
								<p>&nbsp;&nbsp;&nbsp;客户端界面</p>
							</li>
							<img src="picture/app3.jpg" width="270px" height="310px" style="margin-left: 120px;" >
						</ul>

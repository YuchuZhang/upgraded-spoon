...
<body>
	<div class="wai">
		...
		<div class="lun">
			<div class="map">
				<img src="picture/kd1.jpg" width="1920px" height="425px">
			</div>
			<div class="p">
				<p>
					您现在的位置： <a href="index.jsp">首页></a> <a href="kdfw.jsp">蜗牛服务></a>
			...
			<div class="per">
				...
				<div class="per2">
					<ul>
						...
						<p class="per2body">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							蜗牛快递提供专业化的仓储、配送管理服务，调动资深的仓储管理人员和充分利用现有全国各基地和配送中心资源，
							并采用先进的WMS及BOS等信息系统，将运输管理、仓库管理以及订单管理进行一体化整合，针对客户需求订制个性化解决方案。 <img
								src="picture/cp.PNG" style="margin-top: 90px;">
					</ul>

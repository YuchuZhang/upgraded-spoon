			...
			<div class="lun">
				...
				<div class="per">
					<div class="per1">
							...
							<li>
								<a href="kdfw.jsp">-&nbsp;快递服务</a>
							</li>
							<li>
								<a href="zzfw.jsp">-&nbsp;增值服务</a>
							</li>
							<li>
								<a href="cpyth.jsp">-&nbsp;仓配一体化服务</a>
							</li>
							<li>
								<a href="dzsw.jsp">-&nbsp;电子商务服务</a>
							</li>
							<li>
								<a href="fwbzzc.jsp">-&nbsp;服务保障支持</a>
							</li>
							<li>
								<a href="fwzq.jsp">-&nbsp;服务专区</a>
							</li>
							<li>
								<a href="ydzq.jsp">-&nbsp;移动专区</a>
							</li>
							<li>
								<a href="khzn.jsp">-&nbsp;客户指南</a>
							</li>
						</ul>
					</div>
					<div class="per2">
						<ul>
							...
							<p class="per2title">运管体系</p>
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								蜗牛快递运管体系拥有全方位、多层次、多功能，覆盖全国的运营网络，布局合理的分拨中心，
								 强大的车辆资源配置，先进的运营模式，最优化的线路设计，最高效的实时分拨。 
								 公司目前拥有100多个集散分拨中心，分布于全国重点城市；拥有班车30000多辆，
								 航空线路400多条， 强大的运营网络，优化的布局，规范的路由，实现货物的全天候运输。 </p>

							<p class="per2title">网管体系</p>
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								目前，蜗牛快递拥有上海、杭州、北京、南京、广州、无锡、济南、青岛、合肥、 
								东莞、武汉、天津、西安、福州、长沙等多家合资、 基本覆盖发达地区县级以上城市，
								 辐射全国大部分的地级市 现已实现江浙沪皖无盲区派送，形成了以长江三角洲、珠江三角洲、 
								 环渤海地区为重点区域的快递网络布局。 </p>

							<p class="per2title">保障体系</p>
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 蜗牛快递设有客服、信息、财务、质控、人资、企划、投融资、电商、市场、行政、采购、
								 工程管理、秘书中心等多个职能管理部门，各个部门高效沟通，团结协作， 
								 为公司业务的开展及运营提供强有力的服务保障。 截止到2015年末，
								 蜗牛快递在全国设有800多个独立呼叫中心，坐席超4000个， 最高峰值话务量达25万，
								 自动服务24小时不间断， 为客户提供货物查询、在线下单、业务查询、服务投诉等服务。
								  各个部门高效沟通，团结协作，为公司业务的开展及运营提供强有力的服务保障。 </p>

   ...
   <script type="text/javascript" src="res/jquery-3.2.1.js"></script>
    <style type="text/css">
        *{list-style: none;text-decoration: none;}
        ...
        .p a{color: grey;}
        .per1{width:320px;height: 1002px;border: 1px solid #ddd;background-color: #ffffff;margin-left: 6%;}
        .per2{width:850px;height: 980px;border: 1px solid #ddd;background-color: #ffffff;padding-top: 20px;
        ...
        .per2 ul li p{color:#0055a2;font-size:22px;line-height: 28px;margin-left: -20px;}
          .location {
            width: 100%;
            color: rgb(0, 85, 162);
            height: 40px;
                ...
                <ul>
                   <li><div class="location">
                    ...
                    <video width="320" height="240" controls>
                        <source src="picture/1.mp4" type="video/mp4">

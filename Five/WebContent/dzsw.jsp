				...
				<div class="per">
					...
					<div class="per2">
						<ul>
							...
							<p class="per2body">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 北京、上海、东莞、成都、武汉、泉州六大电子商务仓，近十万平方米仓容，专为电子商务用户设计，商家只需提供订单数据， 运货到指定仓，“仓配一体化”服务将为商家提供包括“卸货、质检、理货、拣货、包装、配送、跟单、信息推送”等一条龙服务。
								<img src="picture/dz.png" height="400px" style="padding-left: 100px;">
